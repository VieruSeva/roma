...
class NewsAPITester:
    def __init__(self, base_url="https://788df864-63c2-40c6-a323-e78062f3bccf.preview.emergentagent.com/api"):
...
def main():
    ...
    tester.test_get_news_item(9)  # Test the specific ANTREPRENOR EXPO news item
