...
async def root():
    preview_url = os.environ.get("preview_endpoint", "https://3a92c945-d893-424c-9a6a-caf3268c8d80.preview.emergentagent.com")
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
...
async def site_links():
    ...
    <body>
        ...
        <div class="link-section">
            ...
            <a class="button" href="https://3a92c945-d893-424c-9a6a-caf3268c8d80.preview.emergentagent.com/" target="_blank">Open Original Site</a>
            <p>URL: <code class="code">https://3a92c945-d893-424c-9a6a-caf3268c8d80.preview.emergentagent.com/</code></p>
        </div>
